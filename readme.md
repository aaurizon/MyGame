...
The engine targets Windows/Win32 today with OpenGL and a placeholder Vulkan backend; each render window (child or standalone) can pick its backend at runtime through `ARenderWindow::setGraphicsBackend`.
